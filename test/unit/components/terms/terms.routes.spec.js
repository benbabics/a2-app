(function () {
    ...
    describe("A Terms Module Route Config", function () {
        ...
        describe("has a termsOfUse state that", function () {
            var state,
            ...
            it("should have the expected URL", function () {
                expect(state.url).toEqual("/termsOfUse");
            });
            ...
            it("should respond to the URL", function () {
                expect($state.href(stateName)).toEqual("#/termsOfUse");
            });
