        ...
        describe("An Authorization Profile Collection", function () {
            ...
            describe("has a fetch function that", function () {
                ...
                it("should call super", function () {
                    expect(AuthorizationProfileCollection.__super__.fetch).toHaveBeenCalledWith(mockOptions);
                });
            });

            describe("has a toJSON function that", function () {
                it("is defined", function () {
                    expect(authorizationProfileCollection.toJSON).toBeDefined();
                });

                it("is a function", function () {
                    expect(authorizationProfileCollection.toJSON).toEqual(jasmine.any(Function));
                });
                ...
                describe("when the list of models is null", function () {
                    ...
                    beforeEach(function () {
                        authorizationProfileCollection.reset();

                        actualValue = authorizationProfileCollection.toJSON();
                    });
                ...
                xdescribe("when there are models in the collection", function () {
                    var mockAuthorizationProfiles,
                        authorizationProfile1,
                        authorizationProfile2,
                        actualValue;
                        ...
                        mockAuthorizationProfiles = [
                            {
                                id: 134613456,
                                name: "56256gv261",
                                productRestriction: 5427567
                            },
                            {
                                id: 2456724567,
                                name: "Dewey, Cheetum and Howe",
                                productRestriction: 36736783687
                            }
                        ];
                        authorizationProfile1 = new AuthorizationProfileModel();
                        authorizationProfile1.initialize(mockAuthorizationProfiles[0]);
                        authorizationProfile2 = new AuthorizationProfileModel();
                        authorizationProfile2.initialize(mockAuthorizationProfiles[1]);

                        authorizationProfileCollection.add(authorizationProfile1);
                        authorizationProfileCollection.add(authorizationProfile2);

                        spyOn(authorizationProfile1, "toJSON").and.callThrough();
                        spyOn(authorizationProfile2, "toJSON").and.callThrough();

                        actualValue = authorizationProfileCollection.toJSON();
                    });

                    it("should call toJSON on authorizationProfile1", function () {
                        expect(authorizationProfile1.toJSON).toHaveBeenCalledWith();
                    });

                    it("should call toJSON on authorizationProfile2", function () {
                        expect(authorizationProfile2.toJSON).toHaveBeenCalledWith();
                    });

                    it("should return the expected value", function () {
                        expect(actualValue).toEqual(mockAuthorizationProfiles);
                    });
                });
            });
        });
