    ...
    function (Squire) {
        ...
        describe("An Update Prompt Subscriber", function () {
            ...
            it("should call the subscribeTo function on the facade", function () {
                ...
                expect(mockFacade.subscribeTo.mostRecentCall.args[0]).toEqual("updatePrompt");
                expect(mockFacade.subscribeTo.mostRecentCall.args[1]).toEqual(mockUpdatePromptController);
            });
            ...
            describe("has an init function that", function () {
                beforeEach(function () {
                    spyOn(mockUpdatePromptController, "init").andCallThrough();
                ...
                it("should call the init function on the controller", function () {
                    ...
                    expect(mockUpdatePromptController.init.mostRecentCall.args.length).toEqual(0);
                });
            });
        });
    });
