(function () {
    ...
    /* @ngInject */
    function DriversApiRestangular(Restangular, globals, AuthorizationHeaderRequestInterceptor,
        ...
        function setUpConfiguration(RestangularConfigurer) {
            RestangularConfigurer.setBaseUrl(globals.DRIVER_API.BASE_URL);
    ...
    angular
        .module("app.api")
        .factory("DriversApiRestangular", DriversApiRestangular);
})();