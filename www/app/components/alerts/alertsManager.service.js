(function () {
    ...
    /* @ngInject */
    function AlertsManager(_, globals, $rootScope, Logger, LoggerUtil, AlertModel, AlertsResource) {
            ...
            return AlertsResource.getAlerts(params)
                .then(function (response) {
                    if (response && response.data) {
                        ...
                        var fetchedAlerts = _.map(response.data.notifications, createAlert);
                        ...
                        cachedAlerts = _.uniqBy(cachedAlerts.concat(fetchedAlerts), "id");
        ...
        function deleteAlert(alert) {
            return AlertsResource.deleteAlert(alert.id)
                .then(function () {
